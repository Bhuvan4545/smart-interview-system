...
try {
    ...
    app_log_error('Admin students list', $e);
    $studentsError = 'Unable to load students. Please try again later.';
}
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <main class="main-content">
        ...
        <div class="section">
            <?php if ($studentsError): ?>
                <div class="alert alert-error"><?php echo htmlspecialchars($studentsError); ?></div>
