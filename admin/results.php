...
try {
    ...
    app_log_error('Admin results list', $e);
    $resultsError = 'Unable to load results. Please try again later.';
}
?>
<!DOCTYPE html>
<html lang="en">
...
<a href="logout.php">
    ...
    <div>
        ...
        <div class="section">
            <?php if ($resultsError): ?>
                <div class="alert alert-error"><?php echo htmlspecialchars($resultsError); ?></div>
