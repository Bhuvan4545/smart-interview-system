...
try {
    ...
    app_log_error('Admin load question for edit', $e);
    $_SESSION['delete_error'] = 'Failed to load the question. Please try again.';
    header('Location: delete_question.php');
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            ...
            app_log_error('Admin edit question', $e);
            $errors[] = 'Failed to update question due to a system error. Please try again later.';
        }
    }
}
