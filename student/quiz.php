...
try {
    ...
    app_log_error('Quiz load questions', $e);
    $quizLoadError = 'Failed to load questions. Please try again later.';
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $totalQuestions > 0) {
    ...
    try {
        ...
        app_log_error('Quiz save result', $e);
        $resultSaveError = 'Your score could not be saved. Please contact support.';
    }
}
?>
<!DOCTYPE html>
...
<div class="layout">
    ...
    <main class="main-content">
        ...
        <div class="section">
            <?php if ($quizLoadError): ?>
                <div class="alert alert-error"><?php echo htmlspecialchars($quizLoadError); ?></div>
            <?php endif; ?>

            <?php if ($resultSaveError): ?>
                <div class="alert alert-error"><?php echo htmlspecialchars($resultSaveError); ?></div>
            <?php endif; ?>
