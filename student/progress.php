...
try {
    ...
    app_log_error('Student progress', $e);
    $progressError = 'Unable to load progress data. Please try again later.';
}
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="layout">
    ...
    <main class="main-content">
        ...
        <?php if ($progressError): ?>
            <div class="alert alert-error"><?php echo htmlspecialchars($progressError); ?></div>
        <?php endif; ?>
