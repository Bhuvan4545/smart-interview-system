...
try {
    ...
    app_log_error('Student dashboard', $e);
    $dashboardError = 'Unable to load dashboard data. Please try again later.';
}
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="layout">
    ...
    <main class="main-content">
        ...
        <?php if ($dashboardError): ?>
            <div class="alert alert-error"><?php echo htmlspecialchars($dashboardError); ?></div>
        <?php endif; ?>
