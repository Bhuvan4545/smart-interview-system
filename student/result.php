...
try {
    ...
    app_log_error('Student latest result', $e);
    $resultError = 'Unable to load your latest result. Please try again later.';
}
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="layout">
    ...
    <main class="main-content">
        ...
        <div class="section">
            <?php if ($resultError): ?>
                <div class="alert alert-error"><?php echo htmlspecialchars($resultError); ?></div>
            <?php elseif (!$latest): ?>
